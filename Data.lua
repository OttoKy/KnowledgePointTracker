...
-- Contains all knowledge point source definitions organized by expansion
...
-- ============================================================================
PKT.Expansions = {
    DF = { key = "DF", name = "Dragonflight", order = 1 },
    TWW = { key = "TWW", name = "The War Within", order = 2 },
    MIDNIGHT = { key = "MIDNIGHT", name = "Midnight", order = 3 },
}

-- Ordered list for dropdown
PKT.ExpansionOrder = { "DF", "TWW", "MIDNIGHT" }

-- ============================================================================
-- SHARED DATA (same across all expansions)
-- ============================================================================
PKT.SkillLineIDs = {
    Alchemy = 171,
    Blacksmithing = 164,
...
-- ============================================================================
-- EXPANSION-SPECIFIC DATA CONTAINER
-- ============================================================================
PKT.ExpansionData = {}

-- ============================================================================
-- THE WAR WITHIN (TWW) DATA
-- ============================================================================
PKT.ExpansionData.TWW = {
    -- Expansion SkillLine IDs (for specializations)
    SkillLineIDs = {
        Alchemy = 2871,
        Blacksmithing = 2872,
        Enchanting = 2874,
    ...
    Treasures = {
        ...
        Herbalism = {
            { name = "Dornogal Gardening Scythe",   questID = 83875, zone = "Dornogal",       mapID = 2339, x = 59.14, y = 23.87 },
        ...
        Mining = {
            ...
            { name = "Regenerating Ore",            questID = 83909, zone = "Ringing Deeps",  mapID = 2214, x = 62.0, y = 66.2 },
            { name = "Earthen Excavator's Shovel",  questID = 83908, zone = "Ringing Deeps",  mapID = 2214, x = 45, y = 27.0 },
    ...
    -- WEEKLY GATHERING ITEMS
    WeeklyGatheringItems = {
        Herbalism = {
            blue = { 
                itemID = 224264, 
...
-- ============================================================================
-- DRAGONFLIGHT (DF) DATA - PLACEHOLDER
-- ============================================================================
PKT.ExpansionData.DF = {
    SkillLineIDs = {
        Alchemy = 2823,
        Blacksmithing = 2822,
        Enchanting = 2825,
    ...
    -- PLACEHOLDER: Add real treasure data here
    Treasures = {
        Alchemy = {
            { name = "DF Alchemy Treasure 1", questID = 70208, zone = "The Waking Shores", mapID = 2022, x = 55.0, y = 45.0 },
            -- Add more...
        },
        Blacksmithing = {},
        Enchanting = {},
    ...
    -- PLACEHOLDER: Add real weekly quest data here
    WeeklyQuests = {
        Alchemy = { 
            questID = 70530,
            name = "DF Alchemy Weekly",
            maxKP = 2,
            type = "crafting_orders",
        },
        Blacksmithing = { questID = 70531, name = "DF Blacksmithing Weekly", maxKP = 2, type = "crafting_orders" },
        Enchanting = { questID = 70532, name = "DF Enchanting Weekly", maxKP = 2, type = "crafting_orders" },
        Engineering = { questID = 70533, name = "DF Engineering Weekly", maxKP = 2, type = "crafting_orders" },
        Inscription = { questID = 70534, name = "DF Inscription Weekly", maxKP = 2, type = "crafting_orders" },
        Jewelcrafting = { questID = 70535, name = "DF Jewelcrafting Weekly", maxKP = 2, type = "crafting_orders" },
        Leatherworking = { questID = 70536, name = "DF Leatherworking Weekly", maxKP = 2, type = "crafting_orders" },
        Tailoring = { questID = 70537, name = "DF Tailoring Weekly", maxKP = 2, type = "crafting_orders" },
        Herbalism = { questIDs = { 70613, 70614, 70615 }, name = "DF Herbalism Weekly", maxKP = 3, type = "trainer_quest" },
        Mining = { questIDs = { 70616, 70617, 70618 }, name = "DF Mining Weekly", maxKP = 3, type = "trainer_quest" },
        Skinning = { questIDs = { 70619, 70620, 70621 }, name = "DF Skinning Weekly", maxKP = 3, type = "trainer_quest" },
    },

    PatronOrdersMax = {
        Alchemy = 16, Blacksmithing = 24, Enchanting = 0, Engineering = 16,
        Inscription = 24, Jewelcrafting = 16, Leatherworking = 24, Tailoring = 24,
    },
    ...
    TreatiseItems = {
        Alchemy = { questID = 74108, itemID = 194697, name = "Draconic Treatise on Alchemy" },
        Blacksmithing = { questID = 74109, itemID = 194698, name = "Draconic Treatise on Blacksmithing" },
        Enchanting = { questID = 74110, itemID = 194699, name = "Draconic Treatise on Enchanting" },
        Engineering = { questID = 74111, itemID = 194700, name = "Draconic Treatise on Engineering" },
        Herbalism = { questID = 74107, itemID = 194704, name = "Draconic Treatise on Herbalism" },
        Inscription = { questID = 74105, itemID = 194699, name = "Draconic Treatise on Inscription" },
        Jewelcrafting = { questID = 74112, itemID = 194703, name = "Draconic Treatise on Jewelcrafting" },
        Leatherworking = { questID = 74113, itemID = 194700, name = "Draconic Treatise on Leatherworking" },
        Mining = { questID = 74106, itemID = 194708, name = "Draconic Treatise on Mining" },
        Skinning = { questID = 74114, itemID = 201023, name = "Draconic Treatise on Skinning" },
        Tailoring = { questID = 74115, itemID = 194698, name = "Draconic Treatise on Tailoring" },
    },
...
-- ============================================================================
-- MIDNIGHT DATA - PLACEHOLDER
-- ============================================================================
PKT.ExpansionData.MIDNIGHT = {
    SkillLineIDs = {
        -- PLACEHOLDER: Fill in when Midnight releases
        Alchemy = 9001,
        Blacksmithing = 9002,
        Enchanting = 9003,
        Engineering = 9004,
    ...
    -- ONE-TIME TREASURES (MIDNIGHT)
    Treasures = {
        Alchemy = {
            { name = "Freshly Plucked Peacebloom",  questID = 89115, zone = "Silvermoon City",    mapID = 2393, x = 49.1, y = 75.8 },
            { name = "Pristine Potion",             questID = 89117, zone = "Silvermoon City",    mapID = 2393, x = 47.8, y = 51.8 },
            { name = "Vial of Zul'Aman Oddities",   questID = 89114, zone = "Zul'Aman",           mapID = 2437, x = 40.4, y = 51.1 },
            { name = "Measured Ladle",              questID = 89116, zone = "Atal'Aman",          mapID = 2536, x = 49.1, y = 23.6 },
            { name = "Vial of Rootlands Oddities",  questID = 89113, zone = "Harandar",           mapID = 2413, x = 34.8, y = 24.7 },
            { name = "Vial of Voidstorm Oddities",  questID = 89112, zone = "Slayer's Rise",      mapID = 2444, x = 41.9, y = 40.6 },
            -- { name = "Failed Experiment",        questID = nil,   zone = "Unknown",            mapID = nil,  x = 0,    y = 0 },
            -- { name = "Vial of Eversong Oddities",questID = nil,   zone = "Unknown",            mapID = nil,  x = 0,    y = 0 },
        },
        Blacksmithing = {
            { name = "Sin'dorei Master's Forgemace",   questID = 89183, zone = "Silvermoon City", mapID = 2393, x = 49.2, y = 61.3 },
            { name = "Silvermoon Blacksmith's Hammer",  questID = 89184, zone = "Silvermoon City", mapID = 2393, x = 48.5, y = 74.7 },
            { name = "Deconstructed Forge Techniques",  questID = 89177, zone = "Silvermoon City", mapID = 2393, x = 26.9, y = 60.3 },
            { name = "Metalworking Cheat Sheet",        questID = 89180, zone = "Eversong Woods",  mapID = 2395, x = 56.8, y = 40.8 },
            { name = "Silvermoon Smithing Kit",         questID = 89178, zone = "Eversong Woods",  mapID = 2395, x = 48.3, y = 75.8 },
            { name = "Carefully Racked Spear",          questID = 89179, zone = "Atal'Aman",       mapID = 2536, x = 33.2, y = 65.9 },
            { name = "Rutaani Floratender's Sword",     questID = 89182, zone = "Harandar",        mapID = 2413, x = 66.3, y = 50.9 },
            { name = "Voidstorm Defense Spear",         questID = 89181, zone = "Voidstorm",       mapID = 2444, x = 30.6, y = 69.0 },
        },
        Enchanting = {
            { name = "Sin'dorei Enchanting Rod",    questID = 89107, zone = "Eversong Woods",  mapID = 2395, x = 63.5, y = 32.6 },
            { name = "Everblazing Sunmote",         questID = 89103, zone = "Eversong Woods",  mapID = 2395, x = 60.8, y = 53.0 },
            { name = "Loa-Blessed Dust",            questID = 89106, zone = "Zul'Aman",        mapID = 2437, x = 40.4, y = 51.1 },
            { name = "Enchanted Amani Mask",        questID = 89100, zone = "Atal'Aman",       mapID = 2536, x = 48.4, y = 22.9 },
            { name = "Primal Essence Orb",          questID = 89105, zone = "Harandar",        mapID = 2413, x = 65.8, y = 50.2 },
            { name = "Entropic Shard",              questID = 89104, zone = "Harandar",        mapID = 2413, x = 37.7, y = 65.3 },
            { name = "Pure Void Crystal",           questID = 89102, zone = "Voidstorm",       mapID = 2405, x = 35.5, y = 58.8 },
            -- { name = "Enchanted Sunfire Silk",   questID = nil,   zone = "Unknown",         mapID = nil,  x = 0,    y = 0 },
        },
        Engineering = {
            { name = "One Engineer's Junk",             questID = 89133, zone = "Silvermoon City", mapID = 2393, x = 51.2, y = 74.6 },
            { name = "What To Do When Nothing Works",   questID = 89139, zone = "Silvermoon City", mapID = 2393, x = 51.3, y = 57.0 },
            { name = "Manual of Mistakes and Mishaps",  questID = 89135, zone = "Eversong Woods",  mapID = 2395, x = 39.6, y = 45.8 },
            { name = "Offline Helper Bot",              questID = 89138, zone = "Atal'Aman",       mapID = 2536, x = 65.3, y = 35.0 },
            { name = "Handy Wrench",                    questID = 89140, zone = "Zul'Aman",        mapID = 2437, x = 34.2, y = 87.8 },
            { name = "Expeditious Pylon",               questID = 89136, zone = "Harandar",        mapID = 2413, x = 68.0, y = 49.8 },
            { name = "Ethereal Stormwrench",            questID = 89137, zone = "Slayer's Rise",   mapID = 2444, x = 54.1, y = 51.1 },
            { name = "Miniaturized Transport Skiff",    questID = 89134, zone = "Slayer's Rise",   mapID = 2444, x = 28.9, y = 39.1 },
        },
        Inscription = {
            { name = "Songwriter's Pen",            questID = 89073, zone = "Silvermoon City", mapID = 2393, x = 47.7, y = 50.4 },
            { name = "Songwriter's Quill",          questID = 89074, zone = "Eversong Woods",  mapID = 2395, x = 40.3, y = 61.2 },
            { name = "Spare Ink",                   questID = 89069, zone = "Eversong Woods",  mapID = 2395, x = 48.3, y = 75.6 },
            { name = "Leather-Bound Techniques",    questID = 89068, zone = "Zul'Aman",        mapID = 2437, x = 40.5, y = 49.4 },
            { name = "Leftover Sanguithorn Pigment",questID = 89071, zone = "Harandar",        mapID = 2413, x = 52.7, y = 50.0 },
            { name = "Intrepid Explorer's Marker",  questID = 89070, zone = "Harandar",        mapID = 2413, x = 52.4, y = 52.6 },
            { name = "Void-Touched Quill",          questID = 89067, zone = "Voidstorm",       mapID = 2444, x = 60.7, y = 84.3 },
            -- { name = "Half-Baked Techniques",    questID = nil,   zone = "Unknown",         mapID = nil,  x = 0,    y = 0 },
        },
        Jewelcrafting = {
            { name = "Sin'dorei Masterwork Chisel", questID = 89122, zone = "Silvermoon City", mapID = 2393, x = 50.6, y = 56.6 },
            { name = "Vintage Soul Gem",            questID = 89127, zone = "Silvermoon City", mapID = 2393, x = 55.4, y = 48.0 },
            { name = "Poorly Rounded Vial",         questID = 89125, zone = "Eversong Woods",  mapID = 2395, x = 56.6, y = 40.9 },
            { name = "Sin'dorei Gem Faceters",      questID = 89129, zone = "Eversong Woods",  mapID = 2395, x = 39.6, y = 38.9 },
            -- { name = "Speculative Voidstorm Crystal", questID = nil, zone = "Unknown",      mapID = nil,  x = 0,    y = 0 },
            -- { name = "Ethereal Gem Pliers",      questID = nil,   zone = "Unknown",         mapID = nil,  x = 0,    y = 0 },
            -- { name = "Shattered Glass",          questID = nil,   zone = "Unknown",         mapID = nil,  x = 0,    y = 0 },
            -- { name = "Dual-Function Magnifiers", questID = nil,   zone = "Unknown",         mapID = nil,  x = 0,    y = 0 },
            -- { name = "Prismatic Light Shard",    questID = nil,   zone = "Unknown",         mapID = nil,  x = 0,    y = 0 },
        },
        Leatherworking = {
            { name = "Artisan's Considered Order",  questID = 89096, zone = "Silvermoon City", mapID = 2393, x = 44.8, y = 56.2 },
            { name = "Bundle of Tanner's Trinkets", questID = 89092, zone = "Atal'Aman",       mapID = 2536, x = 45.4, y = 45.5 },
            { name = "Amani Leatherworker's Tool",  questID = 89089, zone = "Zul'Aman",        mapID = 2437, x = 33.1, y = 78.9 },
            { name = "Prestigiously Racked Hide",   questID = 89091, zone = "Zul'Aman",        mapID = 2437, x = 30.8, y = 84.0 },
            { name = "Ethereal Leatherworking Knife",questID = 89090, zone = "Voidstorm",      mapID = 2405, x = 34.7, y = 57.0 },
            { name = "Haranir Leatherworking Mallet",questID = 89094, zone = "Harandar",       mapID = 2413, x = 51.7, y = 51.3 },
            { name = "Haranir Leatherworking Knife",questID = 89095, zone = "Harandar",        mapID = 2413, x = 36.1, y = 25.2 },
            { name = "Patterns: Beyond the Void",   questID = 89093, zone = "Voidstorm",       mapID = 2444, x = 53.7, y = 51.7 },
        },
        Mining = {
            { name = "Solid Ore Punchers",          questID = 89147, zone = "Eversong Woods",  mapID = 2395, x = 38.0, y = 45.4 },
            { name = "Amani Expert's Chisel",       questID = 89149, zone = "Atal'Aman",       mapID = 2536, x = 33.4, y = 65.9 },
            { name = "Spelunker's Lucky Charm",     questID = 89145, zone = "Zul'Aman",        mapID = 2437, x = 42.0, y = 46.5 },
            { name = "Spare Expedition Torch",      questID = 89151, zone = "Harandar",        mapID = 2413, x = 38.8, y = 65.9 },
            { name = "Star Metal Deposit",          questID = 89150, zone = "Voidstorm",       mapID = 2405, x = 41.8, y = 38.3 },
            { name = "Miner's Guide to Voidstorm",  questID = 89144, zone = "Slayer's Rise",   mapID = 2444, x = 30.5, y = 69.1 },
            { name = "Glimmering Void Pearl",       questID = 89148, zone = "Slayer's Rise",   mapID = 2444, x = 28.7, y = 38.5 },
            { name = "Lost Voidstorm Satchel",      questID = 89146, zone = "Slayer's Rise",   mapID = 2444, x = 54.2, y = 51.5 },
        },
        Skinning = {
            { name = "Sin'dorei Tanning Oil",       questID = 89171, zone = "Silvermoon City", mapID = 2393, x = 43.2, y = 55.7 },
            { name = "Thalassian Skinning Knife",   questID = 89173, zone = "Eversong Woods",  mapID = 2395, x = 48.4, y = 76.3 },
            { name = "Cadre Skinning Knife",        questID = 89167, zone = "Atal'Aman",       mapID = 2536, x = 44.9, y = 45.2 },
            { name = "Amani Skinning Knife",        questID = 89172, zone = "Zul'Aman",        mapID = 2437, x = 33.1, y = 79.1 },
            { name = "Amani Tanning Oil",           questID = 89170, zone = "Zul'Aman",        mapID = 2437, x = 40.4, y = 36.0 },
            { name = "Primal Hide",                 questID = 89168, zone = "Harandar",        mapID = 2413, x = 69.5, y = 49.2 },
            { name = "Lightbloom Afflicted Hide",   questID = 89166, zone = "Harandar",        mapID = 2413, x = 76.0, y = 51.0 },
            { name = "Voidstorm Leather Sample",    questID = 89169, zone = "Slayer's Rise",   mapID = 2444, x = 45.5, y = 42.3 },
        },
        Tailoring = {
            { name = "A Really Nice Curtain",           questID = 89079, zone = "Silvermoon City", mapID = 2393, x = 35.9, y = 61.3 },
            { name = "Particularly Enchanting Tablecloth", questID = 89084, zone = "Silvermoon City", mapID = 2393, x = 31.8, y = 68.2 },
            { name = "Sin'dorei Outfitter's Ruler",     questID = 89080, zone = "Eversong Woods",  mapID = 2395, x = 46.3, y = 34.8 },
            { name = "Artisan's Cover Comb",            questID = 89085, zone = "Zul'Aman",        mapID = 2437, x = 40.5, y = 49.4 },
            { name = "Wooden Weaving Sword",            questID = 62655, zone = "Harandar",        mapID = 2413, x = 69.8, y = 51.0 }, -- Check ID?
            { name = "A Child's Stuffy",                questID = 89078, zone = "Harandar",        mapID = 2413, x = 70.5, y = 50.9 },
            { name = "Book of Sin'dorei Stitches",      questID = 89082, zone = "Voidstorm",       mapID = 2444, x = 62.0, y = 83.6 },
            { name = "Satin Throw Pillow",              questID = 89083, zone = "Voidstorm",       mapID = 2444, x = 61.6, y = 85.0 },
        },
        Herbalism = {
            { name = "Simple Leaf Pruners",         questID = 89160, zone = "Silvermoon City", mapID = 2393, x = 49.0, y = 75.9 },
            { name = "A Spade",                     questID = 89158, zone = "Eversong Woods",  mapID = 2395, x = 64.2, y = 30.5 },
            { name = "Peculiar Lotus",              questID = 89156, zone = "Voidstorm",       mapID = 2405, x = 34.7, y = 57.0 },
            { name = "Planting Shovel",             questID = 89155, zone = "Harandar",        mapID = 2413, x = 51.1, y = 55.7 },
            { name = "Bloomed Bud",                 questID = 89162, zone = "Harandar",        mapID = 2413, x = 38.3, y = 66.9 },
            { name = "Lightbloom Root",             questID = 89159, zone = "Harandar",        mapID = 2413, x = 36.6, y = 25.1 },
            { name = "Harvester's Sickle",          questID = 89157, zone = "Harandar",        mapID = 2413, x = 76.1, y = 51.1 },
            -- { name = "Sweeping Harvester's Sythe",questID = nil,   zone = "Unknown",         mapID = nil,  x = 0,    y = 0 },
        },
    },

        -- WEEKLY QUESTS (MIDNIGHT)
    -- questID = 0 means "unknown yet" (collector will discover & export real IDs)
    WeeklyQuests = {
        -- Crafting order weeklies
        Alchemy = {
            questID = 93724,
            name = "Alchemy Services Requested (Silvermoon City)",
            maxKP = 2,
            type = "crafting_orders",
        },
        Blacksmithing = {
            questID = 93726,
            name = "Blacksmithing Services Requested (Silvermoon City)",
            maxKP = 2,
            type = "crafting_orders",
        },
        Enchanting = {
            questID = 0,
            name = "Enchanting Services Requested (Silvermoon City)",
            maxKP = 3,
            type = "crafting_orders",
        },
        Engineering = {
            questID = 93727,
            name = "Engineering Services Requested (Silvermoon City)",
            maxKP = 2,
            type = "crafting_orders",
        },
        Inscription = {
            questID = 93728,
            name = "Inscription Services Requested (Silvermoon City)",
            maxKP = 2,
            type = "crafting_orders",
        },
        Jewelcrafting = {
            questID = 93729,
            name = "Jewelcrafting Services Requested (Silvermoon City)",
            maxKP = 2,
            type = "crafting_orders",
        },
        Leatherworking = {
            questID = 93731,
            name = "Leatherworking Services Requested (Silvermoon City)",
            maxKP = 2,
            type = "crafting_orders",
        },
        Tailoring = {
            questID = 93730,
            name = "Tailoring Services Requested (Silvermoon City)",
            maxKP = 2,
            type = "crafting_orders",
        },

        -- Gathering weeklies (often rotate; you’ll build the full list over time)
        Herbalism = {
            questIDs = {}, -- will become { 12345, 12346, ... }
            name = "Herbalism Weekly",
            maxKP = 3,
            type = "trainer_quest",
        },
    ...
    ArtisanBooks = {},
    KejBooks = {},
    DarkmoonFaire = { kpPerProfession = 3, note = "Monthly event" },
}

-- ============================================================================
-- DATA ACCESS HELPER FUNCTIONS
-- These functions return data for the currently selected expansion
-- ============================================================================

-- Get raw expansion data table
function PKT.GetExpansionData(expansionKey)
    expansionKey = expansionKey or (PKT_DB and PKT_DB.settings and PKT_DB.settings.selected_expansion) or "TWW"
    return PKT.ExpansionData[expansionKey] or PKT.ExpansionData.TWW
end

-- Get expansion skill line IDs
function PKT.GetExpansionSkillLineIDs()
    local data = PKT.GetExpansionData()
    return data.SkillLineIDs or {}
end

-- Get treasures for current expansion
function PKT.GetTreasures()
    local data = PKT.GetExpansionData()
    return data.Treasures or {}
end

-- Get weekly quests for current expansion
function PKT.GetWeeklyQuests()
    local data = PKT.GetExpansionData()
    return data.WeeklyQuests or {}
end

-- Get weekly treasure items for current expansion
function PKT.GetWeeklyTreasureItems()
    local data = PKT.GetExpansionData()
    return data.WeeklyTreasureItems or {}
end

-- Get weekly gathering items for current expansion
function PKT.GetWeeklyGatheringItems()
    local data = PKT.GetExpansionData()
    return data.WeeklyGatheringItems or {}
end

-- Get treatise items for current expansion
function PKT.GetTreatiseItems()
    local data = PKT.GetExpansionData()
    return data.TreatiseItems or {}
end

-- Get artisan books for current expansion
function PKT.GetArtisanBooks()
    local data = PKT.GetExpansionData()
    return data.ArtisanBooks or {}
end

-- Get kej books for current expansion
function PKT.GetKejBooks()
    local data = PKT.GetExpansionData()
    return data.KejBooks or {}
end

-- Get renown books for a profession (current expansion)
function PKT.GetRenownBooksForProfession(profName)
    local data = PKT.GetExpansionData()
    local renownBooks = data.RenownBooks or {}
    local books = {}
    
    for factionKey, factionData in pairs(renownBooks) do
...
function PKT.GetCurrentExpansionName()
    local key = (PKT_DB and PKT_DB.settings and PKT_DB.settings.selected_expansion) or "TWW"
    local expData = PKT.Expansions[key]
    return expData and expData.name or "The War Within"
end